...
KATEGORIE = ['Drogowe', 'Porzadkowe', 'Kryminalne']

RODZAJE_DROGOWE = ['Wypadek', 'Kolizja', 'Katastrofa ladowa']
OPISY_DROGOWE = [
    'Zdarzenie spowodowalo utrudnienia w ruchu drogowym.',
    'Na miejsce wezwano patrol policji i sluzby ratunkowe.',
    'Zgloszenie zostalo odnotowane przez dyzurnego o poranku.',
    'Ruch na drodze zostal czasowo wstrzymany.',
    'Zabezpieczono teren zdarzenia i wykonano dokumentacje fotograficzna.',
    'Uczestnicy zdarzenia zostali przebadani alkomatem.',
    'Pojazdy uczestniczace w zdarzeniu zostaly odholowane z miejsca zdarzenia.',
    'Zdarzenie odnotowano w ewidencji systemu SEWiK.',
]

RODZAJE_PORZADKOWE = ['Zaklocenie porzadku publicznego', 'Spozywanie alkoholu w miejscu publicznym', 'Wandalizm']
OPISY_PORZADKOWE = [
    'Na miejscu interweniowal patrol prewencji.',
    'Osoby uczestniczace w zdarzeniu zostaly wylegitymowane.',
    'Zgloszenie wplynelo od mieszkancow okolicznego budynku.',
    'Sporzadzono notatke urzedowa i zabezpieczono nagranie z monitoringu.',
    'Uczestnicy zdarzenia zostali pouczeni o obowiazujacych przepisach.',
    'Zdarzenie mialo miejsce w godzinach wieczornych.',
    'Miejsce zdarzenia zostalo uprzatniete po zakonczeniu interwencji.',
    'Nie odnotowano osob poszkodowanych.',
    'Zachowanie uczestnikow zaklocalo spokoj publiczny.',
    'Interwencje zakonczono bez uzycia srodkow przymusu bezposredniego.',
]

RODZAJE_KRYMINALNE = ['Kradziez mienia', 'Pobicie', 'Wlamanie']
OPISY_KRYMINALNE = [
    'Na miejsce zdarzenia skierowano grupe dochodzeniowo-sledcza.',
    'Zabezpieczono slady biologiczne oraz odciski palcow.',
    'Zdarzenie zostalo zgloszone przez swiadka.',
    'Funkcjonariusze przeprowadzili ogledziny miejsca zdarzenia.',
    'Poszkodowany zostal przesluchany w charakterze swiadka.',
    'Wszczeto postepowanie przygotowawcze pod nadzorem prokuratora.',
    'Zabezpieczono nagranie z monitoringu miejskiego.',
    'Sporzadzono protokol z miejsca zdarzenia.',
    'W toku czynnosci ustalono potencjalnych sprawcow.',
    'Zdarzenie zostalo wpisane do systemu KSIP.',
    'Nie stwierdzono zagrozenia dla osob postronnych.',
    'Na miejscu obecny byl technik kryminalistyki.',
]

DZIELNICE = ['Przymorze Male', 'Przymorze Wielkie', 'Oliwa', 'Wrzeszcz Dolny', 'Wrzeszcz Gorny', 'Srodmiescie',
             'Aniolki', 'Brzezno', 'Jasien', 'Chelm', 'Matarnia', 'Letnica', 'Piecki- Migowo', 'Stogi', 'Siedlce']

WARUNKI_POGODOWE = [
    "Slonecznie, sucha nawierzchnia",
    "Pochmurno, sucha nawierzchnia",
    "Deszcz, mokra nawierzchnia",
    "Ulewa, bardzo mokra nawierzchnia",
    "Mgla, ograniczona widocznosc",
    "Lekki snieg, sliska nawierzchnia",
    "Obfite opady sniegu, bardzo sliska nawierzchnia",
    "Gololedz, ekstremalnie sliska nawierzchnia",
    "Lekka mzawka, wilgotna nawierzchnia",
...
PRZYCZYNY_ZDARZEN_Z_KARAMI = [
    {
        "przyczyna": "Niezachowanie bezpiecznej odleglosci miedzy pojazdami",
        "podstawa_prawna": "Art. 19 Prawa o ruchu drogowym",
        "mozliwe_kary": ["mandat", "pouczenie"],
        "kwota_mandatu": [100, 300],
        "punkty_karne": 2
    },
    {
        "przyczyna": "Niezastosowanie sie do sygnalizacji swietlnej",
    ...
    {
        "przyczyna": "Niedostosowanie predkosci do warunkow ruchu",
        "podstawa_prawna": "Art. 19 Prawa o ruchu drogowym",
        "mozliwe_kary": ["mandat", "wniosek_do_sadu"],
        "kwota_mandatu": [200, 500],
        "punkty_karne": 10
    },
    {
        "przyczyna": "Nieprawidlowe wyprzedzanie",
    ...
    {
        "przyczyna": "Nieustapienie pierwszenstwa przejazdu",
    ...
    {
        "przyczyna": "Jazda pod wplywem alkoholu",
        "podstawa_prawna": "Art. 87 Kodeksu wykroczen",
        "mozliwe_kary": ["wniosek_do_sadu", "mandat"],
        "kwota_mandatu": [2500, 5000],
        "punkty_karne": 10
    },
    {
        "przyczyna": "Jazda pod wplywem srodkow odurzajacych",
        "podstawa_prawna": "Art. 87a Kodeksu wykroczen",
        "mozliwe_kary": ["wniosek_do_sadu"],
        "kwota_mandatu": [0, 0],
        "punkty_karne": 10
    },
    {
        "przyczyna": "Zmeczenie lub zasniecie za kierownica",
        "podstawa_prawna": "Art. 86 Kodeksu wykroczen",
        "mozliwe_kary": ["mandat", "pouczenie"],
        "kwota_mandatu": [200, 400],
        "punkty_karne": 4
    },
    {
        "przyczyna": "Uzywanie telefonu podczas jazdy",
    ...
    {
        "przyczyna": "Nieprawidlowe manewry na skrzyzowaniu",
    ...
    {
        "przyczyna": "Przekroczenie dopuszczalnej predkosci do 20 km/h",
        "podstawa_prawna": "Art. 88 Kodeksu wykroczen",
        "mozliwe_kary": ["mandat", "pouczenie"],
        "kwota_mandatu": [100, 300],
        "punkty_karne": 2
    },
    {
        "przyczyna": "Przekroczenie dopuszczalnej predkosci o 21-40 km/h",
        "podstawa_prawna": "Art. 88 Kodeksu wykroczen",
        "mozliwe_kary": ["mandat"],
    ...
    {
        "przyczyna": "Przekroczenie dopuszczalnej predkosci o ponad 40 km/h",
        "podstawa_prawna": "Art. 88 Kodeksu wykroczen",
        "mozliwe_kary": ["wniosek_do_sadu", "mandat"],
    ...
    {
        "przyczyna": "Nieprawidlowe zachowanie wobec pieszego",
    ...
    {
        "przyczyna": "Jazda bez wymaganych swiatel",
    ...
    {
        "przyczyna": "Nieprawidlowe zachowanie na przejsciu dla pieszych",
...
def save_to_bulk(data, filename_template, headers):
    ...
    with open(bulk_filename, 'w', encoding='utf-8') as f:
        f.write(FIELD_TERMINATOR.join(headers) + ROW_TERMINATOR)
...
def generuj_notowanych(ilosc, existing_pesels=None):
    ...
    while len(rekordy) < ilosc:
        ...
        imie = fake_en.first_name_male() if plec == 'M' else fake.first_name_female()
        nazwisko = fake_en.last_name_male() if plec == 'M' else fake.last_name_female()
...
def przydziel_typy_kar(kary, zdarzenia_do_przyczyn, przyczyny_info_map):
    ...
    for nr_sprawy, id_zdarzenia, _, _ in kary:
        ...
        if kara_type == "mandat":
            ...
            wnioski.append([nr_sprawy, "Sad Rejonowy Gdansk-Poludnie", f"III W {random.randint(1, 999)}", rodzaj_wniosku])
    return mandaty, pouczenia, wnioski

def snapshot1(target_records=500000, data_dir='snapshot1_data'):
    print("\n" + "=" * 60 + f"\nSTART SNAPSHOT 1: Generowanie ~{target_records:,} rekordow\n" + "=" * 60)
    ...
    print(f"\nSNAPSHOT 1 ZAKOnCZONY! Wygenerowano {len(kary):,} kar.")
...
def snapshot2(s1_data, target_records=500000, data_dir='snapshot2_data'):
    print("\n" + "=" * 60 + f"\nSTART SNAPSHOT 2: Aktualizacje i ~{target_records:,} nowych rekordow\n" + "=" * 60)

    print("   - Generowanie danych ze zmianami (SCD2 / Update)...")
    ...
    for index, row in kobiety_df.sample(frac=0.05).iterrows():
        nowe_nazwisko = fake.last_name_female()
        oryginalny_rekord = s1_data['notowani'][index]
        zmieniony_rekord = list(oryginalny_rekord)
        zmieniony_rekord[2] = nowe_nazwisko
        notowani_zmiany.append(zmieniony_rekord)
    ...
    nieprzyjete = mandaty_df[mandaty_df['CzyPrzyjety'] == 0]
    for index, row in nieprzyjete.sample(frac=0.10).iterrows():
        nr_sprawy = row['NrSprawy']
        
        if 'mandaty_dict' not in locals():
             mandaty_dict = {m[0]: m for m in s1_data['mandaty']}
        
        oryginalny_rekord = mandaty_dict.get(nr_sprawy)
        if oryginalny_rekord:
            zmieniony_rekord = list(oryginalny_rekord)
            zmieniony_rekord[2] = 1
            mandaty_zmiany.append(zmieniony_rekord)

    print("\n   - Generowanie nowych danych (Patrole, Zdarzenia)...")
    avg_kary_per_patrol = 10
    avg_patrole_per_day = 7.5
    needed_days = int((target_records / avg_kary_per_patrol) / avg_patrole_per_day)
    needed_notowani = int(target_records * 0.3)
    ...
    print("   - Tworzenie zbioru istniejacych PESEL-i...")
    ...
    save_to_bulk(notowani_zmiany, f'{data_dir}/notowani_zmiany.csv', ['PESEL', 'Imie', 'Nazwisko', 'DataUrodzenia', 'Plec'])
    save_to_bulk(mandaty_zmiany, f'{data_dir}/mandaty_zmiany.csv', ['NrSprawy', 'Kwota', 'CzyPrzyjety', 'PunktyKarne', 'SeriaNumerMandatu', 'TerminPlatnosciDni'])
    ...
    wszyscy_notowani_do_zapisu = nowi_notowani + notowani_zmiany
    save_to_bulk(wszyscy_notowani_do_zapisu, f'{data_dir}/notowani.csv', ['PESEL', 'Imie', 'Nazwisko', 'DataUrodzenia', 'Plec'])
    
    wszystkie_mandaty_do_zapisu = mandaty + mandaty_zmiany
    save_to_bulk(wszystkie_mandaty_do_zapisu, f'{data_dir}/mandaty.csv', ['NrSprawy', 'Kwota', 'CzyPrzyjety', 'PunktyKarne', 'SeriaNumerMandatu', 'TerminPlatnosciDni'])
    
    print(f"\nSNAPSHOT 2 ZAKONCZONY! Wygenerowano {len(kary):,} nowych kar oraz {len(notowani_zmiany)} zmian osobowych.")
...
def podsumowanie(s1, s2):
    print("\n" + "=" * 60)
    print("PODSUMOWANIE KOnCOWE - ANALIZA WYGENEROWANYCH DANYCH")
    print("=" * 60)
    ...
    print(f"    Notowani: {len(notowani):,} osob")
    print(f"    Zdarzenia: {len(zdarzenia):,} (w tym {len(zdarzenia_drogowe):,} drogowych)")
    print(f"    Sprawcy zdarzen: {len(sprawcy):,} powiazan")
    print(f"    Patrole: {len(patrole):,} (srednio {len(patrole) / liczba_dni_patroli:.1f} patroli/dzien)")
    ...
    katastrofy = len([z for z in zdarzenia_drogowe if id_do_rodzaju.get(z[0]) == 'Katastrofa ladowa'])
    ...
    print(f"\nEFEKTYWNOsc PATROLI:")
    print(f"    srednia kar na patrol: {len(kary) / len(patrole):.1f}")
    ...
    print(f"    Wnioski do sadu: {len(wnioski)} ({len(wnioski) / len(kary) * 100:.1f}%)")

    poprawne_czasowo = len(kary)
    print(f"\nSPRAWDZENIE POPRAWNOsCI:")
    print(
        f"    Powiazania czasowe: {poprawne_czasowo}/{len(kary)} ({poprawne_czasowo / len(kary) * 100:.1f}%)")

    print(f"\nRELACJE MIeDZY ENCJAMI:")
    print(f"    Zdarzenia ze sprawcami: {len(set(s[1] for s in sprawcy))}/{len(zdarzenia)} zdarzen")
    print(f"    Notowani ze zdarzeniami: {len(set(s[0] for s in sprawcy))}/{len(notowani)} osob")
    print(f"    Kary nalozone na zdarzenia: {len(set(k[1] for k in kary))}/{len(zdarzenia)} zdarzen")

    print("\n" + "=" * 60)
    print("SUKCES: Zakonczono generowanie i analize danych!")
    print("=" * 60)
...
if __name__ == '__main__':
    ...
    koniec = time.time()
    print("\n" + "=" * 60)
    print(f"Wszystkie operacje zakonczone pomyslnie!")
    print(f"   Calkowity czas wykonania: {(koniec - start):.2f} sekund.")
    print("=" * 60)